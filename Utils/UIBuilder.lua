...
function UIBuilder:Tooltip(frame, text, name, gametooltip)
    if (gametooltip) then
        local tt = StdUi:Tooltip(frame, text, name, "TOP", true)
        return tt
    else
        local tt = StdUi:FrameTooltip(frame, text, name, "TOP", true)
        return tt
    end
end
